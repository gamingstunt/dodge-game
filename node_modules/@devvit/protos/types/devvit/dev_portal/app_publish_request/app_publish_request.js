 ...
 */
export var AppPublishRequestPendingState;
(function (AppPublishRequestPendingState) {
    AppPublishRequestPendingState[AppPublishRequestPendingState["AWAITING_REVIEW"] = 0] = "AWAITING_REVIEW";
    AppPublishRequestPendingState[AppPublishRequestPendingState["AWAITING_PANEL_REVIEW"] = 1] = "AWAITING_PANEL_REVIEW";
    AppPublishRequestPendingState[AppPublishRequestPendingState["IN_REVIEW"] = 2] = "IN_REVIEW";
    AppPublishRequestPendingState[AppPublishRequestPendingState["ON_HOLD"] = 3] = "ON_HOLD";
    AppPublishRequestPendingState[AppPublishRequestPendingState["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(AppPublishRequestPendingState || (AppPublishRequestPendingState = {}));
export function appPublishRequestPendingStateFromJSON(object) {
    switch (object) {
        case 0:
        case "AWAITING_REVIEW":
            return AppPublishRequestPendingState.AWAITING_REVIEW;
        case 1:
        case "AWAITING_PANEL_REVIEW":
            return AppPublishRequestPendingState.AWAITING_PANEL_REVIEW;
        case 2:
        case "IN_REVIEW":
            return AppPublishRequestPendingState.IN_REVIEW;
        case 3:
        case "ON_HOLD":
            return AppPublishRequestPendingState.ON_HOLD;
        case -1:
        case "UNRECOGNIZED":
        default:
            return AppPublishRequestPendingState.UNRECOGNIZED;
    }
}
export function appPublishRequestPendingStateToJSON(object) {
    switch (object) {
        case AppPublishRequestPendingState.AWAITING_REVIEW:
            return 0;
        case AppPublishRequestPendingState.AWAITING_PANEL_REVIEW:
            return 1;
        case AppPublishRequestPendingState.IN_REVIEW:
            return 2;
        case AppPublishRequestPendingState.ON_HOLD:
            return 3;
        case AppPublishRequestPendingState.UNRECOGNIZED:
        default:
            return -1;
    }
}
export var AutomatedAppReviewDecision;
(function (AutomatedAppReviewDecision) {
    AutomatedAppReviewDecision[AutomatedAppReviewDecision["AUTOMATED_APP_REVIEW_DECISION_UNSPECIFIED"] = 0] = "AUTOMATED_APP_REVIEW_DECISION_UNSPECIFIED";
    AutomatedAppReviewDecision[AutomatedAppReviewDecision["AUTOMATED_APP_REVIEW_DECISION_APPROVED"] = 1] = "AUTOMATED_APP_REVIEW_DECISION_APPROVED";
    AutomatedAppReviewDecision[AutomatedAppReviewDecision["AUTOMATED_APP_REVIEW_DECISION_REJECTED"] = 2] = "AUTOMATED_APP_REVIEW_DECISION_REJECTED";
    AutomatedAppReviewDecision[AutomatedAppReviewDecision["AUTOMATED_APP_REVIEW_DECISION_NEEDS_REVIEW"] = 3] = "AUTOMATED_APP_REVIEW_DECISION_NEEDS_REVIEW";
    AutomatedAppReviewDecision[AutomatedAppReviewDecision["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(AutomatedAppReviewDecision || (AutomatedAppReviewDecision = {}));
export function automatedAppReviewDecisionFromJSON(object) {
    switch (object) {
        case 0:
        case "AUTOMATED_APP_REVIEW_DECISION_UNSPECIFIED":
            return AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_UNSPECIFIED;
        case 1:
        case "AUTOMATED_APP_REVIEW_DECISION_APPROVED":
            return AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_APPROVED;
        case 2:
        case "AUTOMATED_APP_REVIEW_DECISION_REJECTED":
            return AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_REJECTED;
        case 3:
        case "AUTOMATED_APP_REVIEW_DECISION_NEEDS_REVIEW":
            return AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_NEEDS_REVIEW;
        case -1:
        case "UNRECOGNIZED":
        default:
            return AutomatedAppReviewDecision.UNRECOGNIZED;
    }
}
export function automatedAppReviewDecisionToJSON(object) {
    switch (object) {
        case AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_UNSPECIFIED:
            return 0;
        case AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_APPROVED:
            return 1;
        case AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_REJECTED:
            return 2;
        case AutomatedAppReviewDecision.AUTOMATED_APP_REVIEW_DECISION_NEEDS_REVIEW:
            return 3;
        case AutomatedAppReviewDecision.UNRECOGNIZED:
        default:
            return -1;
    }
}
export var AutomatedAppReviewStatus;
(function (AutomatedAppReviewStatus) {
    AutomatedAppReviewStatus[AutomatedAppReviewStatus["AUTOMATED_APP_REVIEW_STATUS_UNSPECIFIED"] = 0] = "AUTOMATED_APP_REVIEW_STATUS_UNSPECIFIED";
    AutomatedAppReviewStatus[AutomatedAppReviewStatus["AUTOMATED_APP_REVIEW_STATUS_PENDING"] = 1] = "AUTOMATED_APP_REVIEW_STATUS_PENDING";
    AutomatedAppReviewStatus[AutomatedAppReviewStatus["AUTOMATED_APP_REVIEW_STATUS_COMPLETED"] = 2] = "AUTOMATED_APP_REVIEW_STATUS_COMPLETED";
    AutomatedAppReviewStatus[AutomatedAppReviewStatus["AUTOMATED_APP_REVIEW_STATUS_ERROR"] = 3] = "AUTOMATED_APP_REVIEW_STATUS_ERROR";
    AutomatedAppReviewStatus[AutomatedAppReviewStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(AutomatedAppReviewStatus || (AutomatedAppReviewStatus = {}));
export function automatedAppReviewStatusFromJSON(object) {
    switch (object) {
        case 0:
        case "AUTOMATED_APP_REVIEW_STATUS_UNSPECIFIED":
            return AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_UNSPECIFIED;
        case 1:
        case "AUTOMATED_APP_REVIEW_STATUS_PENDING":
            return AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_PENDING;
        case 2:
        case "AUTOMATED_APP_REVIEW_STATUS_COMPLETED":
            return AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_COMPLETED;
        case 3:
        case "AUTOMATED_APP_REVIEW_STATUS_ERROR":
            return AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_ERROR;
        case -1:
        case "UNRECOGNIZED":
        default:
            return AutomatedAppReviewStatus.UNRECOGNIZED;
    }
}
export function automatedAppReviewStatusToJSON(object) {
    switch (object) {
        case AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_UNSPECIFIED:
            return 0;
        case AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_PENDING:
            return 1;
        case AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_COMPLETED:
            return 2;
        case AutomatedAppReviewStatus.AUTOMATED_APP_REVIEW_STATUS_ERROR:
            return 3;
        case AutomatedAppReviewStatus.UNRECOGNIZED:
        default:
            return -1;
    }
}
function createBaseAutomatedAppReview() {
    return {
        id: "",
        createdAt: undefined,
        updatedAt: undefined,
...
export const AutomatedAppReview = {
    $type: "devvit.dev_portal.app_publish_request.AutomatedAppReview",
    ...
    decode(input, length) {
        ...
        const message = createBaseAutomatedAppReview();
    ...
    fromJSON(object) {
        return {
            ...
            decision: isSet(object.decision) ? automatedAppReviewDecisionFromJSON(object.decision) : 0,
            status: isSet(object.status) ? automatedAppReviewStatusFromJSON(object.status) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.decision !== 0) {
            obj.decision = automatedAppReviewDecisionToJSON(message.decision);
        }
        if (message.status !== 0) {
            obj.status = automatedAppReviewStatusToJSON(message.status);
        }
        return obj;
    },
    create(base) {
        return AutomatedAppReview.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAutomatedAppReview();
...
messageTypeRegistry.set(AutomatedAppReview.$type, AutomatedAppReview);
...
export const FullPublishRequestInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.automatedReviews) {
            AutomatedAppReview.encode(v, writer.uint32(90).fork()).ldelim();
        }
        if (message.pendingState !== undefined) {
            writer.uint32(96).int32(message.pendingState);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11:
                    ...
                    message.automatedReviews.push(AutomatedAppReview.decode(reader, reader.uint32()));
                    continue;
                case 12:
                    if (tag !== 96) {
                        break;
                    }
                    message.pendingState = reader.int32();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            appInstallationCount: isSet(object.appInstallationCount)
                ...
                : undefined,
            automatedReviews: globalThis.Array.isArray(object?.automatedReviews)
                ? object.automatedReviews.map((e) => AutomatedAppReview.fromJSON(e))
                : [],
            pendingState: isSet(object.pendingState) ? appPublishRequestPendingStateFromJSON(object.pendingState) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.automatedReviews?.length) {
            obj.automatedReviews = message.automatedReviews.map((e) => AutomatedAppReview.toJSON(e));
        }
        if (message.pendingState !== undefined) {
            obj.pendingState = appPublishRequestPendingStateToJSON(message.pendingState);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.automatedReviews = object.automatedReviews?.map((e) => AutomatedAppReview.fromPartial(e)) || [];
        message.pendingState = object.pendingState ?? undefined;
        return message;
    },
};
...
function createBaseAppPRUpdateRequest() {
    return {
        ...
        appSlugAndVersionNumber: undefined,
        status: 0,
        pendingState: undefined,
    };
}
export const AppPRUpdateRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.pendingState !== undefined) {
            writer.uint32(40).int32(message.pendingState);
        }
        return writer;
    },
    decode(input, length) {
...
export const AppPRFindManyRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        for (const v of message.pendingStates) {
            writer.int32(v);
        }
        writer.ldelim();
        return writer;
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    if (tag === 64) {
                        message.pendingStates.push(reader.int32());
                        continue;
                    }
                    if (tag === 66) {
                        const end2 = reader.uint32() + reader.pos;
    ...
    fromJSON(object) {
        return {
            ...
            statuses: globalThis.Array.isArray(object?.statuses)
                ...
                : [],
            pendingStates: globalThis.Array.isArray(object?.pendingStates)
                ? object.pendingStates.map((e) => appPublishRequestPendingStateFromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.pendingStates?.length) {
            obj.pendingStates = message.pendingStates.map((e) => appPublishRequestPendingStateToJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.pendingStates = object.pendingStates?.map((e) => e) || [];
        return message;
    },
};
