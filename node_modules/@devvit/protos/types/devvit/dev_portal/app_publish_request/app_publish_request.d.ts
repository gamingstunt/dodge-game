 ...
 */
export declare enum AppPublishRequestPendingState {
    AWAITING_REVIEW = 0,
...
export declare function appPublishRequestPendingStateFromJSON(object: any): AppPublishRequestPendingState;
export declare function appPublishRequestPendingStateToJSON(object: AppPublishRequestPendingState): number;
export declare enum AutomatedAppReviewDecision {
...
export declare function automatedAppReviewDecisionFromJSON(object: any): AutomatedAppReviewDecision;
export declare function automatedAppReviewDecisionToJSON(object: AutomatedAppReviewDecision): number;
export declare enum AutomatedAppReviewStatus {
...
export declare function automatedAppReviewStatusFromJSON(object: any): AutomatedAppReviewStatus;
export declare function automatedAppReviewStatusToJSON(object: AutomatedAppReviewStatus): number;
export interface AutomatedAppReview {
    id: string;
    ...
    model: string;
    response: string;
    decision: AutomatedAppReviewDecision;
    status: AutomatedAppReviewStatus;
}
export interface FullPublishRequestInfo {
    ...
    automatedReviews: AutomatedAppReview[];
    /**
     ...
     */
    pendingState?: AppPublishRequestPendingState | undefined;
}
...
export interface AppPRFindManyRequest {
    ...
    pendingStates: AppPublishRequestPendingState[];
}
...
export declare const AutomatedAppReview: {
    $type: "devvit.dev_portal.app_publish_request.AutomatedAppReview";
    encode(message: AutomatedAppReview, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): AutomatedAppReview;
    fromJSON(object: any): AutomatedAppReview;
    toJSON(message: AutomatedAppReview): unknown;
    create(base?: DeepPartial<AutomatedAppReview>): AutomatedAppReview;
    fromPartial(object: DeepPartial<AutomatedAppReview>): AutomatedAppReview;
};
